...
class CatelogueFragment: Fragment() {
    ...
    private fun initData(){
        ...
        catalogueModelList.addAll(
            ...
            CatalogueModel.ProductsBean("Red Pants",R.drawable.redpant,BigDecimal(100).setScale(2),BigDecimal(2),"Pants",BigDecimal(110).setScale(2),"6"),
            CatalogueModel.ProductsBean("Blue Shoes",R.drawable.shoesblue,BigDecimal(500).setScale(2),BigDecimal(2),"Shoes",BigDecimal(550).setScale(2),"9"),
            CatalogueModel.ProductsBean("Red Shoes",R.drawable.shoesred,BigDecimal(500).setScale(2),BigDecimal(12),"Shoes",BigDecimal(550).setScale(2),"10"),
            )
        )
